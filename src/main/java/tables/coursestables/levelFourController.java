...
public class levelFourController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try{
            ...
            ResultSet resultSet = con.createStatement().executeQuery("SELECT * from courses where course_year = 'graduation year' ");
